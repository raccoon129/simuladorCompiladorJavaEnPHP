function compile() {
    ...
    fetch('index.php', {
        ...
        .then(data => {
            ...
            if (data.result.compilacion.startsWith("Error:")) {
                document.getElementById('puntuacion-value').innerText = '0';
                document.getElementById('puntuacion').style.color = 'red'; // Color rojo para error
            } else {
                document.getElementById('puntuacion-value').innerText = '100';
                document.getElementById('puntuacion').style.color = 'green'; // Color verde para éxito
            }
        })
        .catch(error => {
